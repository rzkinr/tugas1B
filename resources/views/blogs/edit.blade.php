    ...
    <form action="{{ route('blogs.update',$blog->id) }}" method="POST">
        ...
        @method('PUT')
         ...
         <div class="row">
            ...
            <div class="form-group">
                <strong>Place:</strong>
                <input class="form-control" name="place" value="{{ $blog->place }}" placeholder="Place" type="text">
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>Date:</strong>
                <input class="form-control" name="date" value="{{ $blog->date }}" placeholder="Description" type="date">
            </div>
        </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
